# Generated by Django 2.2.16 on 2022-12-04 11:13
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('reviews', '0005_auto_20221203_1801'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Оценка не может быть меньше 1'), django.core.validators.MaxValueValidator(10, message='Оценка не может быть больше 10')], verbose_name='Oценка')),
